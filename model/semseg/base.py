...
from model.backbone.resnet import resnet18, resnet50, resnet50_v1, resnet101

class BaseNet(nn.Module):
    def __init__(self, backbone):
        super(BaseNet, self).__init__()
        backbone_zoo = {'resnet18': resnet18, 'resnet50': resnet50, 'resnet50_v1': resnet50_v1,
                        'resnet101': resnet101}
    ...
    def forward(self, x, gt=None, tta=False):
        if not tta:
